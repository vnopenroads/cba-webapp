        ...
        <div className='page__body--landing'>
          <div className='inner'>
            ...
            <div className='cta-block'>
              <Link to={`/en/assets`} className='button button--xlarge button--base-raised-light'><T>View assets</T></Link> <small>or</small> <Link to={`/en/explore`} className='button button--xlarge button--primary-raised-dark'><T>Explore on map</T></Link>
            </div>
          </div>
        </div>
      </section>
